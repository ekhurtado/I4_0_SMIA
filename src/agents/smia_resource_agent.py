...
class SMIAResourceAgent(SMIAAgent):
    ...
    async def setup(self):
        ...
        fsm_behaviour.add_state(name=SMIAInfo.BOOTING_STATE_NAME, state=StateBootingResource(), initial=True)
        ...
        fsm_behaviour.add_state(name=SMIAInfo.IDLE_STATE_NAME, state=StateIdle())
        ...
        fsm_behaviour.add_transition(source=SMIAInfo.RUNNING_STATE_NAME, dest=SMIAInfo.IDLE_STATE_NAME)
        fsm_behaviour.add_transition(source=SMIAInfo.IDLE_STATE_NAME, dest=SMIAInfo.RUNNING_STATE_NAME)
        fsm_behaviour.add_transition(source=SMIAInfo.IDLE_STATE_NAME, dest=SMIAInfo.STOPPING_STATE_NAME)
