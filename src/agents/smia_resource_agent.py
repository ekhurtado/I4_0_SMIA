...
class SMIAResourceAgent(SMIAAgent):
    ...
    async def setup(self):
        ...
        fsm_behaviour.add_state(name=SMIAInteractionInfo.BOOTING_STATE_NAME, state=StateBootingResource(), initial=True)
        ...
        fsm_behaviour.add_state(name=SMIAInteractionInfo.IDLE_STATE_NAME, state=StateIdle())
        ...
        fsm_behaviour.add_transition(source=SMIAInteractionInfo.RUNNING_STATE_NAME, dest=SMIAInteractionInfo.IDLE_STATE_NAME)
        fsm_behaviour.add_transition(source=SMIAInteractionInfo.IDLE_STATE_NAME, dest=SMIAInteractionInfo.RUNNING_STATE_NAME)
        fsm_behaviour.add_transition(source=SMIAInteractionInfo.IDLE_STATE_NAME, dest=SMIAInteractionInfo.STOPPING_STATE_NAME)
