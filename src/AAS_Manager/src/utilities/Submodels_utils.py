...
def create_technical_data_sm(submodel_data):
    ...
    AAS_Archive_utils.xml_to_file(AASarchiveInfo.SUBMODEL_FOLDER_PATH + '/' + AASarchiveInfo.TECHNICAL_DATA_SM_FILENAME,
...
def create_configuration_sm(submodel_data):
    ...
    # Write the content of submodel in a file
    AAS_Archive_utils.xml_to_file(AASarchiveInfo.SUBMODEL_FOLDER_PATH + '/' + AASarchiveInfo.CONFIGURATION_SM_FILENAME,
                                  etree.tostring(submodel_xml_content))
