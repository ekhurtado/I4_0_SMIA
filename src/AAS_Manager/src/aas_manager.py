...
async def main():
    """
    This is the main method of the AAS Manager, where the agent will be created and started. Depending on the type of asset to be represented, the associated SPADE agent type will be created.
    """
